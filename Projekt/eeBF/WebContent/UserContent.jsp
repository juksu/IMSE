		...
		<nav class="navbar navbar-inverse navbar-static-top">
			<div class="container">
				<ul class="nav navbar-nav">
					<li>
						<!-- Buttons --> <!-- 	                   <form id="uploadForm" action="index" method="get"> -->
						<form class="nav-form" action="KundenServlet" method="get">
							<button type="submit" class="btn btn-primary btn-md navbar-btn" name="useraction" value="shoppingcart">
								Einkaufswagen
							</button>
							
							<button type="submit" class="btn btn-primary btn-md navbar-btn"	name="useraction" value="productsearch">
								Produkt Suchen
							</button>
							
							<button type="submit" class="btn btn-warning btn-md navbar-btn" name="useraction" value="editaccount">
								Account bearbeiten
							</button>
							<button type="submit" class="btn btn-danger btn-md navbar-btn" name="useraction" value="logout">
								Logout
							</button>
						</form>
					</li>
					...
					<li>
						<!-- Buttons -->
						<form action="KundenServlet" method="get">

							<!-- SEHR UNSCHÖN GELÖST FÜR DEN ABSTAND DER BUTTONS -->
							<small>_____</small>
							
							<button type="submit" class="btn btn-info btn-md navbar-btn" name="useraction" value="shoppingcart">
								Einkaufswagen
							</button>
							...
							<button type="submit" class="btn btn-warning btn-sm navbar-btn"
								name="useraction" value="changeaccount">Account
								bearbeiten</button>
							<button type="submit" class="btn btn-danger btn-sm navbar-btn"
								name="useraction" value="logout">Logout</button>
						</form>
